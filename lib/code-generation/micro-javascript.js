...
var translate = exports.translate = function(slabNode) {
    ...
    function translate(slabNode) {
        return translator.translate(slabNode);
    }
    
    return translate(slabNode);
};

var Translator = exports.Translator = function(translate) {
    var translators = {
        ...
        functionCall: function(slabCall) {
            ...
            if (slabCall.func.nodeType === "memberAccess") {
                jsFunc = js.memberAccess(
                    translate(slabCall.func.left),
                    slabCall.func.memberName
                );
            } else {
                jsFunc = translate(slabCall.func);
            }
        ...
        module: function(slabModule) {
            ...
            if (names.length === 0) {
                ...
                slabModule.members.forEach(function(member) {
                    jsMembers[member.name] = translate(member.value);
                });
