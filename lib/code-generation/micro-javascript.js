...
var translators = {
    ...
    typeApplication: function(slabTypeApplication) {
        var jsFunc = translate(slabTypeApplication.func);
        var jsArgs = slabTypeApplication.args.map(translate);
        return js.call(jsFunc, jsArgs, slabTypeApplication);
    },
    ...
    def: function(slabDef) {
        // TODO: tests! [Are the tests really that valuable?]
        return js.var(
            slabDef.identifier,
            js.call(
                js.memberAccess(
