...
var definitionDeclarationRule = lazyRule(function() {
    var identifier = sequence.capture(tokenRules.identifier(), "identifier");
...
var statementTerminator = firstOf(
    "new line or semi-colon",
    newLine(),
    sequence(symbol(";"), optional(newLine())),
    nonConsuming(end()),
    nonConsuming(dedent())
);
...
var singleLineStatement = exports.singleLineStatement = function(rule) {
    ...
    return then(
        sequence(capturedRule, sequence.cut(), statementTerminator),
