...
var translators = {
    ...
    functionDeclaration: function(shedFunction) {
        var slabLambda = slab.lambda(
            translate(shedFunction.formalArguments),
            translate(shedFunction.returnType),
            translate(shedFunction.body),
            shedFunction
        );
        return slab.val(shedFunction.identifier, options.none, slabLambda, shedFunction);
    },
    ifStatement: function(shedIf) {
